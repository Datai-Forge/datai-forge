...
def transform_bronze_to_silver(spark, folder_name):
    ...
    nvp_2017_bronze_path = os.path.join(
        BRONZE_PATH, "niveau_vie_pauvrete_200m", "2017_carreaux_200m_met"
    )
    ...
    df_silver_2017 = df_silver_2017.select(
        [df_silver_2017[c].alias(new_names.get(c, c)) for c in df_silver_2017.columns]
    )
